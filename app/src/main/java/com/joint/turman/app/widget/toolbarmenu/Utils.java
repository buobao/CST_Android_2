...
//        itemTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, context.getResources().getDimension(R.dimen.menu_text_size));
        ...
        itemTextView.setPadding(0, 0, (int) context.getResources().getDimension(R.dimen.menu_text_right_padding), 0);
        ...
        itemTextView.setTextAppearance(context, menuItem.getMenuTextAppearanceStyle() > 0
                ...
                : R.style.MenuTextView_DefaultStyle);
        return itemTextView;
    }
    ...
    public static View getDivider(Context context, MenuObject menuItem) {
        ...
        RelativeLayout.LayoutParams viewLayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) context.getResources().getDimension(R.dimen.menu_divider_height));
        ...
        int dividerColor = menuItem.getDividerColor() == Integer.MAX_VALUE ?
                context.getResources().getColor(R.color.menu_divider_color) :
