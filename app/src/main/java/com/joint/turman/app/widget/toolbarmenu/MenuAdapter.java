...
import com.joint.turman.app.widget.toolbarmenu.interfaces.OnItemClickListener;
import com.joint.turman.app.widget.toolbarmenu.interfaces.OnItemLongClickListener;
 ...
 */
    ...
    private void fillOpenClosingAnimations(boolean isCloseAnimation, List<Animator> textAnimations, List<Animator> imageAnimations, int wrapperPosition) {
        ...
        Animator textTranslation = isCloseAnimation ?
                AnimatorUtils.translationRight(mTextWrapper.getChildAt(wrapperPosition), mContext.getResources().getDimension(R.dimen.menu_text_right_translation))
                : AnimatorUtils.translationLeft(mTextWrapper.getChildAt(wrapperPosition), mContext.getResources().getDimension(R.dimen.menu_text_right_translation));
    ...
    private void buildChosenAnimation(int childIndex) {
        ...
        for (int i = 0; i < childIndex; i++) {
            ...
            fadeOutTextTopAnimatorList.add(AnimatorUtils.fadeOutSet(mTextWrapper.getChildAt(i), mContext.getResources().getDimension(R.dimen.menu_text_right_translation)));
        }
        ...
        for (int i = getItemCount() - 1; i > childIndex; i--) {
            ...
            fadeOutTextBottomAnimatorList.add(AnimatorUtils.fadeOutSet(mTextWrapper.getChildAt(i), mContext.getResources().getDimension(R.dimen.menu_text_right_translation)));
        }
        ...
        AnimatorSet fadeOutChosenText = AnimatorUtils.fadeOutSet(mTextWrapper.getChildAt(childIndex), mContext.getResources().getDimension(R.dimen.menu_text_right_translation));
