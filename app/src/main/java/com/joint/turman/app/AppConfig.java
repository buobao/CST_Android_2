...
public class AppConfig {
    ...
    public final static String TEMP_USER_MY = "temp_user_my";
    ...
    @SuppressLint("NewApi")
    public final static String DEFAULT_SAVE_IMAGE_PATH = Environment.getExternalStorageDirectory()+"/CST/";
    public final static String DEFAULT_IMAGE_CAMERA_PATH = DEFAULT_SAVE_IMAGE_PATH+"/Camera/";
    public final static String DEFAULT_UPDATE_PATH = DEFAULT_SAVE_IMAGE_PATH+"/Update/";
    public final static String DEFAULT_VOICE_DIR = "voiceComment";
